...
import { SignupInput } from "@mourya.vishal2003/medium-common";
...
export const Auth = ({ type }: { type: "signup" | "signin" }) => {
    ...
    async function sendRequest() {
        try {
            const response = await axios.post(`${BACKEND_URL}/api/v1/user/${type === "signup" ? "signup" : "signin"}` , postInputs, {headers: {
